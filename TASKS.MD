...
- [x] **R4.4:** Create playlist from natural language description – 3p (Depends on R2.2)  
- [x] **R4.5:** Determine playlist length intelligently – 1p (Depends on R4.4)  
- [x] **R4.6:** Auto-generate playlist name – 2p (Depends on R4.4)  
...
- [x] **R5.4:** Ask questions (from R3.3) in natural language – 1p (Depends on R5.1, R3.3)  
